...
public class InnerEdgeSchema extends DocEdgeSchema {
    ...
    public InnerEdgeSchema(VertexSchema parentVertexSchema, Direction parentDirection, String index, String type, JSONObject edgeJson, UniGraph graph) throws JSONException {
