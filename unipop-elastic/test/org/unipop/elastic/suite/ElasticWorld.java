...
public class ElasticWorld implements World {
    ...
    public GraphTraversalSource getGraphTraversalSource(final LoadGraphWith.GraphData graphData) {
        try {
            final ElasticGraphProvider provider = new ElasticGraphProvider();
            ...
            throw new IllegalStateException("Could not build/load Elastic graph for " + graphData, ex);
        }
    }
