...
public class ImdbControllerManager implements ControllerManager{
    ...
    public void init(UniGraph graph, Configuration configuration) throws Exception {
        ...
        VertexController movie = new TemplateVertexController(graph, client, elasticMutations, 0, timing, indexName, "dyn_template", ScriptService.ScriptType.FILE, "hits.hits", "aggregations.all.genre.buckets");
        vertexControllers.put("movie", movie);
        vertexControllers.put("bucket", movie);
