...
//    }
    ...
    @Override
    protected Iterator<Traverser.Admin<E>> stepLogic(List<Traverser.Admin<S>> traversers) {
        return coalesce(traversers.iterator());
    }

    private Iterator<Traverser.Admin<E>> coalesce(Iterator<Traverser.Admin<S>> traversers) {
