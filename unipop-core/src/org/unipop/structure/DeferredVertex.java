...
public class DeferredVertex extends BaseVertex {
    public DeferredVertex(Object id, String label, Map<String, Object> properties, UniGraph graph) {
        super(id, label, properties, null, graph);
    }
    ...
    public void loadProperties(Map<String, Object> properties, DeferredVertexController controller) {
        deferred = false;
