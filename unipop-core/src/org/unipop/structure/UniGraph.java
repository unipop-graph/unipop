...
@Graph.OptOut(test = "org.apache.tinkerpop.gremlin.structure.io.IoGraphTest", method = "shouldMigrateClassicGraph", reason = "Federated/remote provider: GraphMigrator streams GraphML through a piped writer thread; if source-graph iteration throws over the network the writer dies and the reader deadlocks on PipedInputStream. Not a correctness gap.")
@Graph.OptOut(test = "org.apache.tinkerpop.gremlin.structure.io.IoGraphTest", method = "shouldMigrateModernGraph", reason = "Federated/remote provider: GraphMigrator streams GraphML through a piped writer thread; if source-graph iteration throws over the network the writer dies and the reader deadlocks on PipedInputStream. Not a correctness gap.")
