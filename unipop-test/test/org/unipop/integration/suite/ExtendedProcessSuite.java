...
/**
 * Created by sbarzilay on 7/10/16.
 */
public class ExtendedProcessSuite extends ProcessStandardSuite {
    public ExtendedProcessSuite(Class<?> klass, RunnerBuilder builder) throws InitializationError {
